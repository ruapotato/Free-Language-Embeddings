...
<tr><td><b>{vshort} (ours)</b></td><td>DFSG-compliant mix</td><td>100K</td><td>300</td>
...
Note: Published models use 10-100x more training data. {vshort} trains on DFSG-compliant sources (Wikipedia, Gutenberg, Stack Exchange, arXiv, etc., ~2B tokens).
...
<p>300d, 100K whole-word vocabulary, trained {step:,} steps on DFSG-compliant mix (~2B tokens).</p>
