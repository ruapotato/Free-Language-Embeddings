...
def parse_step_data(log_path):
    ...
    with open(log_path) as f:
        for line in f:
            ...
            if "step" in line and ("[HYDRA" in line or "[V17" in line or "[V16" in line or "[V18" in line or "[V19]" in line or "[V20]" in line or "[V21]" in line or "[V22]" in line):
                try:
    ...
    with open(log_path) as f:
        for line in f:
            if ("step" in line and "loss" in line and "recon=" in line) or \
               ("step" in line and ("[HYDRA" in line or "[V17" in line or "[V16" in line or "[V18" in line or "[V19]" in line or "[V20]" in line or "[V21]" in line or "[V22]" in line)):
                try:
...
def detect_run():
    ...
    for v in ["v22", "v21", "v20", "v19", "v18", "v17", "v16", "v15", "v14", "v13", "v12", "v11", "v10", "v9", "v8", "v7", "v6", "v5", "v4", "v3", "v2", "v1"]:
...
def list_available_runs():
    ...
    runs = {}
    # Main version logs
    for v in ["v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20", "v21", "v22"]:
