...
def parse_step_data(log_path):
    ...
    with open(log_path) as f:
        for line in f:
            ...
            if "step" in line and ("[HYDRA" in line or "[V17" in line or "[V16" in line or "[V18" in line or "[V19]" in line or "[V20]" in line or "[V21]" in line or "[V22]" in line or "[V23]" in line or "[V24]" in line or "[V25]" in line or "[V26]" in line or "[V27]" in line or "[V28]" in line):
                try:
...
def detect_run():
    ...
    for v in ["v28", "v27", "v26", "v25", "v24", "v23", "v22", "v21", "v20", "v19", "v18", "v17", "v16", "v15", "v14", "v13", "v12", "v11", "v10", "v9", "v8", "v7", "v6", "v5", "v4", "v3", "v2", "v1"]:
...
function updateDashboard(response) {
    ...
    if (isV10 || geo != null || phase) {
        ...
        if (isV10) {
            ...
            } else if (run && run.startsWith('v28')) {
