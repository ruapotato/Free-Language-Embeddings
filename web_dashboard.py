...
def parse_step_data(log_path):
    ...
    with open(log_path) as f:
        for line in f:
            ...
            if "step" in line and ("[HYDRA" in line or "[V17" in line or "[V16" in line or "[V18" in line or "[V19]" in line or "[V20]" in line or "[V21]" in line or "[V22]" in line or "[V23]" in line or "[V24]" in line or "[V25]" in line or "[V26]" in line or "[V27]" in line or "[V28]" in line or "[V29]" in line):
                try:
                    ...
                    row = {
                        "step": step,
                        "recon": grab(r"en=([\d.]+)", line) or grab(r"recon=([\d.]+)", line) or grab(r"\bloss=([\d.]+)", line),
                        "em_ema": grab(r"em_ema=([\d.]+)", line) or grab(r"\bem=([\d.]+)", line),
                    ...
                    # V23: contrastive loss (cl=)
                    cl_val = grab(r"cl=([\d.]+)", line, default=None)
                    if cl_val is not None:
                        row["recon"] = cl_val  # reuse recon field for primary loss
                        row["contrastive_loss"] = cl_val
...
def detect_run():
    ...
    for v in ["v29", "v28", "v27", "v26", "v25", "v24", "v23", "v22", "v21", "v20", "v19", "v18", "v17", "v16", "v15", "v14", "v13", "v12", "v11", "v10", "v9", "v8", "v7", "v6", "v5", "v4", "v3", "v2", "v1"]:
...
def list_available_runs():
    ...
    runs = {}
    # Main version logs
    for v in ["v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20", "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29"]:
...
function updateDashboard(response) {
    ...
    if (isV10 || geo != null || phase) {
        ...
        if (isV10) {
            ...
            } else if (run && (run.startsWith('v28') || run.startsWith('v29'))) {
